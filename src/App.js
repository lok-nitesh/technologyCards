...
const App = () => (
  <div className="app-container">
    <div className="list-container">
      <h1 className="hdng">LEARN 4.0 TECHNOLOGIES</h1>
      <p className="para">
        Get trained by alumni of IITs and Top companies like
        Amazon,Microsoft,Intel,Nvidia,Qualcomm etcLearn Directly from
        professionals involved in Product Development
      </p>
      <ul className="cards-list">
        {cardsList.map(eachPerson => (
          <CardItems Details={eachPerson} key={eachPerson.id} />
        ))}
      </ul>
    </div>
  </div>
